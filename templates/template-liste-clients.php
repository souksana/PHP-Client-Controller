...
<body>
            ...
            foreach ($clients as $client) {
                echo "<tr>
                    ...
                    <td>" . wordwrap($client["telephone"],2," ",1) . "</td>
                        ...
                        <td><form action='/clients/" . $client["idClient"] . "' method='post'>
                        <input type='hidden' name='_method' value='DELETE'>
                        <input type='submit' name='supprimer' id='supprimer' value='Supprimer' class='btn btn-danger'>
                        </form></td>
                        </tr>";
            }
            ?>
    ...
    <div class="liens">
        <a href="/clients/create">Créer un client</a> ou <a href="/clients/recherche">Rechercher un client</a>
    </div>
</body>
